...
const ALLOWED: Hit[] = [
  { file: 'src/engine/audio.ts', line: 31 }, // white-noise SFX buffer, cosmetic
  { file: 'src/systems/battle.ts', line: 32 }, // battleRng's injectable default (was 33 — BALL.1-FB dropped the BALL_ITEM import)
