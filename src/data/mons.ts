...
export const SPECIES: Record<string, MonSpecies> = {
  ...
  // ── SPR.D (CH6 SYLPHCO / CH8 SAFARI): the PSYCHIC and FIGHTING lines ─────
  // Stats and learnsets per .paul/plan/ch6-sylphco/species-audio.md §11 — a
  // first pass, retuned by a feedback card only (CH6.0 assumption 12).
  drowzey: {
    id: 'drowzey',
    name: 'DROWZEY',
    type: ['PSYCHIC'],
    ...
    heightM: 1.0,
    weightKg: 32.4,
    dex: ['EATS DREAMS.', 'LIKES NIGHTMARES.'],
  },
  hypnoz: {
    id: 'hypnoz',
    name: 'HYPNÖZ',
    ...
    heightM: 1.6,
    weightKg: 75.6,
    dex: ['SWINGS A COIN.', 'YOU FEEL SLEEPY.'],
  },
  machopp: {
    id: 'machopp',
    name: 'MACHOPP',
    ...
    heightM: 0.8,
    weightKg: 19.5,
    dex: ['ALL MUSCLE.', 'MOSTLY SHOULDERS.'],
  },
  machoke: {
    id: 'machoke',
    name: 'MACHÖKE',
